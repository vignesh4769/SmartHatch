...
import { HiOutlineCash, HiOutlineUsers, HiOutlineShoppingBag } from "react-icons/hi";
import { MdDashboard, MdOutlineDirectionsWalk, MdOutlineEmail } from "react-icons/md";
  ...
  useEffect(() => {
    const fetchNotifications = async () => {
      ...
      const sampleNotifications = [
        { id: 1, message: "New leave request pending approval", read: false, date: "2023-06-15" },
        { id: 2, message: "Low inventory alert for Chicken Feed", read: false, date: "2023-06-14" },
        { id: 3, message: "Salary processed for June", read: true, date: "2023-06-10" }
      ];
  ...
  return (
    <div className="bg-gray-800 text-white shadow-sm h-16 z-50 flex items-center justify-between px-6 fixed top-0 left-0 w-full shadow-md">
      ...
      <div className="flex items-center">
        <Link to={userRole === "admin" ? "/admin/dashboard" : "/employee/dashboard"} className="flex items-center">
          <img 
            src="/images/logo.jpg" 
          ...
          <li>
            <Link 
              ...
              className={`flex items-center hover:text-gray-300 ${
                location.pathname === '/admin/dashboard' || location.pathname === '/employee/dashboard' ? 'text-indigo-300' : ''
              }`}
            >
            ...
            <>
              <li>
                <Link 
                  to="/admin/employees" 
                  className={`flex items-center hover:text-gray-300 ${
                    location.pathname === '/admin/employees' ? 'text-indigo-300' : ''
                  }`}
                >
              ...
              <li>
                <Link 
                  to="/admin/visitors" 
                  className={`flex items-center hover:text-gray-300 ${
                    location.pathname === '/admin/visitors' ? 'text-indigo-300' : ''
                  }`}
                >
              ...
              <li>
                <Link 
                  to="/admin/inventory" 
                  className={`flex items-center hover:text-gray-300 ${
                    location.pathname === '/admin/inventory' ? 'text-indigo-300' : ''
                  }`}
                >
              ...
              <li>
                <Link 
                  to="/admin/financial" 
                  className={`flex items-center hover:text-gray-300 ${
                    location.pathname === '/admin/financial' ? 'text-indigo-300' : ''
                  }`}
                >
            ...
            <>
              <li>
                <Link 
                  ...
                  className={`flex items-center hover:text-gray-300 ${
                    location.pathname === '/employee/attendance' ? 'text-indigo-300' : ''
                  }`}
                >
              ...
              <li>
                <Link 
                  ...
                  className={`flex items-center hover:text-gray-300 ${
                    location.pathname === '/employee/leave-application' ? 'text-indigo-300' : ''
                  }`}
                >
        ...
        <div className="relative" ref={profileRef}>
          ...
          >
            <div className="w-8 h-8 mr-2">
              <img
                src={user?.profileImage || (userRole === "admin" ? "/images/admin.jpg" : "/images/employee.jpg")}
                alt="Profile"
